...
declare module suncom {
    ...
    namespace Test {
         ...
         * 点击按钮
         */
        function click(btnId: number, type?: string, data?: any): void;

        /**
         * 注册按钮
         * @id: 按钮编号，若为-1则清除所有按钮
         * @ignoreWarning: ID指定的按钮己存在时会有警告日志，传入true忽略该警告，
         */
        function regButton(id: number, button?: any, ignoreWarning?: boolean): void;
    }
}